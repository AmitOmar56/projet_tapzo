...
public class RecentalyProductData {
    ...
    public RecentalyProductData(String titleApp, String titleProductdata, long productPrice,String productAffiliateLink, String imageUrl) {
